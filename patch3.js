...
const anchorBegin = '<div className="relative aspect-video rounded-xl overflow-hidden bg-zinc-100 mb-3">';
const startIdx = code.lastIndexOf('<motion.div', code.indexOf(anchorBegin));

const cartIdx = code.indexOf('Adicionar ao Carrinho', startIdx);
let endIdx = code.indexOf('</motion.div>', cartIdx) + '</motion.div>'.length;

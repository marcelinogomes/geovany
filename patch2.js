...
const t2 = `Adicionar ao Carrinho
                    </button>
                  </motion.div>`;

const idx1 = code.indexOf('<div className="relative aspect-video rounded-xl overflow-hidden bg-zinc-100 mb-3">');

// Backtrack to the <motion.div>
const startToken = '<motion.div';
let startIdx = code.lastIndexOf(startToken, idx1);

let endIdx = code.indexOf(t2, idx1);
